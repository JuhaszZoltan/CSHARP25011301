...
class Barlang
{
    ...
    public int Hossz
    {
        ...
        set
        {
            if (value < hossz) throw new Exception("A hossz nem lehet kisebb a korábbi értéknél!");
            hossz = value;
        }
    }
    ...
    public int Melyseg
    {
        ...
        set
        {
            if (value < melyseg) throw new Exception("A mélység nem lehet kisebb a korábbi értéknél!");
            melyseg = value;
        }
    }
